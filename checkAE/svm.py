...
for feature in features:
    ...
    for act in activities:
        ...
        for us in users:
            ...
            currentUserData = pandas.read_csv('E:/Study/ThesisGit/Thesis/AEMatlab/Eoutput.csv').transpose()
            ...
            impostorData = pandas.read_csv('E:/Study/ThesisGit/Thesis/AEMatlab/Eoutput2.csv').transpose()
            impostorData['target'] = -1
            
            impostorTarget = impostorData['target']
            
            impostorData.drop(["target"], axis=1, inplace=True)
            ...
            y_pred_outliers = model.predict(impostorData)
            
            cm1 = confusion_matrix(impostorTarget, y_pred_outliers)
            totalCM = cm + cm1
