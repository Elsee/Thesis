...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./StatFFTContractiveResults/" + feature + "_StatFFTContractiveRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsFusedContractive3AEStatFFT/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsFusedContractive3AEStatFFT/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
