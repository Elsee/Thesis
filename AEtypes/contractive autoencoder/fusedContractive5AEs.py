...
for feature in features:
    ...
    for act in activities:
        ...
        for us in users:
            ...
            autoencoder_stat, encoder_stat = contractive_autoencoder(10, 21, x_train_stat, x_test_stat);

            autoencoder_time, encoder_time = contractive_autoencoder(4, 9, x_train_time, x_test_time);

            autoencoder_fft, encoder_fft = contractive_autoencoder(3, 6, x_train_fft, x_test_fft);

            autoencoder_wavelet, encoder_wavelet = contractive_autoencoder(10, 21, x_train_wavelet, x_test_wavelet);
            ...
            autoencoder_fused, encoder_fused = contractive_autoencoder(14, 27, x_train_fused, x_test_fused);
