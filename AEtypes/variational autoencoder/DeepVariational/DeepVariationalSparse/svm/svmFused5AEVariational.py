...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./5AEVariationalResults/" + feature + "_VariationalRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            currentUserData = pandas.read_csv('../resultsFusedVariational5AE/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
