...
def gridSearchSVM(feat, act, us):
    ...
    currentUserData = pandas.read_csv('./resultsFusedVariational5AE/AEResult_' + featureType + '_' + activityType + '#' + str(userNum) + '.csv', header = 0)
...
#    
    ...
    with open('./gridSearchRes/gridSearchSVMresults_5AE.txt','a') as f:
