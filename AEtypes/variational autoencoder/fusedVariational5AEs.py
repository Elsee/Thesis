...
#def variational_autoencoder(encoding_layer_dim, intermediate_dim, input_shape, X, X_test):
...
for feature in features:
    ...
    for act in activities:
        ...
        for us in users:
            ...
            autoencoder_fft, encoder_fft = variational_autoencoder(2, 6, x_train_fft, x_test_fft);
            ...
            autoencoder_fused, encoder_fused = variational_autoencoder(14, 26, x_train_fused, x_test_fused);
