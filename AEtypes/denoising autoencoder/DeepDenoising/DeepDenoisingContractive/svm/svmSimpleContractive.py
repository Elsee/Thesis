...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./simpleContractiveResults/" + feature + "_simpleContractiveRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsSimpleContractive/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsSimpleContractive/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
