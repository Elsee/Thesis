...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./simpleDenoisingResults/" + feature + "_simpleDenoisingRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsSimpleDenoising/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsSimpleDenoising/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
