...
def denoising_autoencoder(encoding_layer_dim, intermediate_dim1, input_shape, X, X_noisy, X_test, X_test_noisy):
    # this is the size of our encoded representations
    encoding_dim = encoding_layer_dim
    # this is our input placeholder
    input_img = Input(shape=(input_shape,))
    # "encoded" is the encoded representation of the input
    h1 = Dense(intermediate_dim1, activation='relu')(input_img)
#    h2 = Dense(intermediate_dim1, activation='relu')(h1)
    ...
    decoded_h2 = Dense(intermediate_dim1, activation='relu')(encoded)
...
for feature in features:
    ...
    for act in activities:
        ...
        for us in users:
            ...
            autoencoder_stat, encoder_stat = denoising_autoencoder(12, 17, 21, x_train_stat, x_train_stat_noisy, x_test_stat, x_test_stat_noisy);

            autoencoder_time, encoder_time = denoising_autoencoder(5, 7, 9, x_train_time, x_train_time_noisy, x_test_time, x_test_time_noisy);

            autoencoder_fft, encoder_fft = denoising_autoencoder(4, 5, 6, x_train_fft, x_train_fft_noisy, x_test_fft, x_test_fft_noisy);

            autoencoder_wavelet, encoder_wavelet = denoising_autoencoder(12, 16, 21, x_train_wavelet, x_train_wavelet_noisy, x_test_wavelet, x_test_wavelet_noisy);
            ...
            autoencoder_fused, encoder_fused = denoising_autoencoder(18, 26, 33, x_train_fused, x_train_fused_noisy, x_test_fused, x_test_fused_noisy);
