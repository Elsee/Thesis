...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./5AEDenoisingSandPResults/" + feature + "_SandPRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsFusedDenoisingSandP5AE/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsFusedDenoisingSandP5AE/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
        ...
        with open("results_new_accuracy_SandP/output_origFeatures.csv",'a') as f:
