...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./simpleVariationalResults/" + feature + "_simpleVariationalRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsSimpleVariational/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsSimpleVariational/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
