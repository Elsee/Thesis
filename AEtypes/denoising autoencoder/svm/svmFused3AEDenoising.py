...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./StatFFTDenoisingResults/" + feature + "_StatFFTDenoisingRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsFusedDenoising3AEStatFFT/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsFusedDenoising3AEStatFFT/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
