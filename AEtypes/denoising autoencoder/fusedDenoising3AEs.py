...
#            
#            autoencoder_stat_wave, encoder_stat_wave = denoising_autoencoder(21, 42, x_train_stat_wave, x_train_stat_wave_noisy, x_test_stat_wave, x_test_stat_wave_noisy);
#            
#            autoencoder_time_fft, encoder_time_fft = denoising_autoencoder(8, 15, x_train_time_fft, x_train_time_fft_noisy, x_test_time_fft, x_test_time_fft_noisy);
#            
...
#            
#            autoencoder_fused, encoder_fused = denoising_autoencoder(15, 29, x_train_fused, x_train_fused_noisy, x_test_fused, x_test_fused_noisy);
#            
...
#            
#            autoencoder_stat_time, encoder_stat_time = denoising_autoencoder(16, 30,x_train_stat_time, x_train_stat_time_noisy, x_test_stat_time, x_test_stat_time_noisy);
#            autoencoder_fft_wavelet, encoder_fft_wavelet = denoising_autoencoder(16, 27, x_train_fft_wavelet, x_train_fft_wavelet_noisy, x_test_fft_wavelet, x_test_fft_wavelet_noisy);
#            
...
#            x_test_fused_noisy = x_test_fused + noise
#            
#            autoencoder_fused, encoder_fused = denoising_autoencoder(16, 32, x_train_fused, x_train_fused_noisy, x_test_fused, x_test_fused_noisy);
#            encoded_fused = encoder_fused.predict(concat_encoded)
#
...
# =============================================================================
            ...
            autoencoder_stat_fft, encoder_stat_fft = denoising_autoencoder(14, 27, x_train_stat_fft, x_train_stat_fft_noisy, x_test_stat_fft, x_test_stat_fft_noisy);
            autoencoder_time_wavelet, encoder_time_wavelet = denoising_autoencoder(15, 30, x_train_time_wavelet, x_train_time_wavelet_noisy, x_test_time_wavelet, x_test_time_wavelet_noisy);
