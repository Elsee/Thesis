...
def KNN_Interpolation(featureSpace):
    ...
    for idx, val in enumerate(featureSpace):
        for i in range(NEIGHBOURS_AMOUNT):
            ...
            interpolated_vector = (val-featureSpace[needed_vector])*0.5 + val
...
for feature in features:
    ...
    for act in activities:
        ...
        for us in users:
            ...
            np.savetxt("./resultsFusedExtrapolated5AE/AEResult_" + feature + "_" + act + '#' + str(us) +".csv", encoded_fused, delimiter=',')