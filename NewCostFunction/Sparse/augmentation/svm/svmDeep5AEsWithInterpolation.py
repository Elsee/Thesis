...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./5AEwithInterpolation/" + feature + "_InterpolationRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsFusedInterpolated5AE/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsFusedInterpolated5AE/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
        ...
        with open("results_new_accuracy_with_interpolation/output.csv",'a') as f:
