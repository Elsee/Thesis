...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./5AEwithExtrapolation/" + feature + "_ExtrapolationRes_" + act + ".txt", "a") as myfile:
        ...
        for us in users:
            ...
            filenames = glob.glob('../resultsFusedExtrapolated5AE/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
        ...
        with open("results_new_accuracy_with_extrapolation/output.csv",'a') as f:
