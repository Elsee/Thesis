...
def ae(encoding_layer_dim, input_shape):
    ...
    encoded = Dense(encoding_dim, activation='linear',
                    activity_regularizer=regularizers.l2(0.00001), name='encoded-layer')(input_img)
    # "decoded" is the lossy reconstruction of the input
    decoded = Dense(input_shape, activation='sigmoid')(encoded)
    # this model maps an input to its reconstruction
    autoencoder = Model(input_img, decoded)
    # this model maps an input to its encoded representation
    encoder = Model(input_img, encoded.get_layer('encoded-layer').input)
...
for feature in features:
    ...
    for act in activities:
        ...
        for us in users:
            ...
            autoencoder_fused, encoder_fused, decoder_fused = ae(16, 27);
            ...
            print(autoencoder_time.get_layer('encoded-layer').get_weights()[0])
