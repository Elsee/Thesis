...
for feature in features:
    ...
    for act in activities:
        ...
        for us in range(56):
            ...
            filenames = glob.glob('../resultsFusedDenoising5AE/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsFusedDenoising5AE/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
