...
def gridSearchSVM(feat, act, us):
    ...
    currentUserData = pandas.read_csv('../resultsDeepVAE/AEResult_' + featureType + '_' + activityType + '#' + str(userNum) + '.csv', header = 0)
...
#    
    ...
    with open('./gridSearchRes/gridSearchSVMresults_5VAE.txt','a') as f:
...
for feature in features:
    for act in activities:
        for us in range(56):
            usNum = us + 1
            gridSearchSVM(feature, act, usNum)