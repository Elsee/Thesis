...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./5VAEResults/" + feature + "_VAERes_" + act + ".txt", "a") as myfile:
        ...
        for us in range(56):
            ...
            filenames = glob.glob('../resultsDeepVAE/AEResult_' + featuresType +'_' + activityType + '#*.csv')
            del filenames[us-1]
            ...
            currentUserData = pandas.read_csv('../resultsDeepVAE/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv', header = None)
...
#                writer.writerow([item,])  
        ...
        with open("./5VAEResults/" + feature + "_VAERes_" + act + ".txt", "a") as myfile:
                myfile.write("Mean: \nFRR: " + str("%.5f" % (sumFRR/56)) + "\nFAR: " + str("%.5f" % (sumFAR/56)) + "\n\n\n")
