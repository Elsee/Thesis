...
for feature in features:
    ...
    for act in activities:
        ...
        with open("./5AEVAEResults/" + feature + "_VAERes_" + act + ".txt", "a") as myfile:
        ...
        for us in range(56):
            ...
            filepath = '../resultsFusedVariational5AE/' + act + '/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv'
            if os.path.isfile(filepath): 
            
                filenames = glob.glob('../resultsFusedVariational5AE/' + act + '/AEResult_' + featuresType +'_' + activityType + '#*.csv')
