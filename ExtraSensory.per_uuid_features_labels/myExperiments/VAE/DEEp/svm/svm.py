...
for feature in features:
    ...
    for act in activities:
        ...
        for us in range(1, 57):
            ...
            filepath = '../resultsFusedVariational5AE/' + activityType + '/AEResult_' + featuresType +'_' + activityType + '#' + str(userNum) + '.csv'
            if os.path.isfile(filepath): 

                filenames = glob.glob('../resultsFusedVariational5AE/' + activityType + '/AEResult_' + featuresType +'_' + activityType + '#*.csv')
        ...
        amount_of_users = len(os.listdir('../resultsFusedVariational5AE/' + act))
